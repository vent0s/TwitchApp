...
import com.septim.twitchapp.external.model.GameResponse;
import com.septim.twitchapp.external.model.StreamResponse;
import com.septim.twitchapp.external.model.VideoResponse;
...
public interface TwitchApiClient {
    ...
    StreamResponse getStreams(
            @RequestHeader("Authorization") String authorization,
            @RequestParam("game_id") List<String> gameId,
            @RequestParam("first") int first
    );
}
